...
def gen_route_data(route, db_table, train=1):
    ...
    for variable in explanatory_variables:
        ...
        for index, function in enumerate(functions):
            for period in [7, 14]:
                data[variable+'_'+str(period)+'_'+function_names[index]]=data[variable].rolling(period).agg(function)
                data[variable+'_'+str(period)+'_'+function_names[index]+'_change']=                data[variable+'_'+str(period)+'_'+function_names[index]]                -data[variable+'_'+str(period)+'_'+function_names[index]].shift(period)

                data[variable+'_'+str(period)+'_'+function_names[index]+'_change_shift1']=                    data[variable+'_'+str(period)+'_'+function_names[index]]                    -data[variable+'_'+str(period)+'_'+function_names[index]].shift(1)


                data[variable+'_'+str(period)+'_'+function_names[index]+'_change_percent']=                (data[variable+'_'+str(period)+'_'+function_names[index]                ]/data[variable+'_'+str(period)+'_'+function_names[index]].shift(period)-1)*100


                data[variable+'_'+str(period)+'_'+function_names[index]+'_change_percent_shift1']=                    (data[variable+'_'+str(period)+'_'+function_names[index]                    ]/data[variable+'_'+str(period)+'_'+function_names[index]].shift(1)-1)*100

                data[variable+'_'+str(period)+'_'+function_names[index]+'_up']=                data[variable+'_'+str(period)+'_'+function_names[index]+'_change'].apply(lambda x: 1 if x>0 else 0)

    for variable in explanatory_variables:
        for index, function in enumerate(functions):
            data[variable+'_'+function_names[index]+'_cross']=data[[            variable+'_7_'+function_names[index],variable+'_14_'+function_names[index]]].apply(            lambda x: 1 if x[0]>x[1] else 0, axis=1)
...
model_route='DALLAX' #route to fit model on (try using the average instead??)
...
model_specification_1={'HAUL_ORIGIN_14_mean_change_shift1': 1,  'ITRI_DESTINATION_14_mean_change_percent_shift1': 1,  'ITVI_DESTINATION_14_min_sq': 1,  'OTMS_ORIGIN_14_min_change_sq': 1,  'OTRI_DESTINATION_7_mean_change_percent_shift1': 1,  'OTVI_ORIGIN_14_min_sq': 1,  'TLT_ORIGIN_change_HAUL_ORIGIN_change7_sq': 1,  'TRUK_DESTINATION_14_min_sq': 1,  'VTRI_ORIGIN_change7': 1,  'VTRI_ORIGIN_change_ITMS_ORIGIN_change_sq': 1,'month_end':1,'TRUK_ORIGIN_slump':0}
...
model_specification_3={'HAUL_ORIGIN_7_median_change': 3,  'ITMS_ORIGIN_7_stdev_change': 3,  'ITMS_ORIGIN_change7_TLT_ORIGIN_change7_sq': 3,  'ITRI_DESTINATION_14_mean_change_sq': 3,  'ITVI_DESTINATION_14_mean_sq': 3,  'OTVI_ORIGIN_7_min': 3,  'TRUK_DESTINATION_change_OTRI_DESTINATION_change7_sq': 3,  'TRUK_ORIGIN_change_OTMS_DESTINATION_change': 3,  'VTRI_DESTINATION_change7_TRUK_DESTINATION_change_sq': 3, 'month_end':3,'TRUK_ORIGIN_slump':0}

model_specification_4={'HAUL_DESTINATION_14_min_change_percent': 4,  'ITMS_DESTINATION_7_stdev_change_sq': 4,  'OTMS_DESTINATION_change7_ITRI_ORIGIN_change7': 4,  'OTMS_DESTINATION_change7_TLT_DESTINATION_change7': 4,  'OTMS_DESTINATION_change_VTRI_DESTINATION_change7': 4,  'OTRI_DESTINATION_change7_OTMS_DESTINATION_change': 4,  'OTVI_ORIGIN_change_TRUK_DESTINATION_change': 4,  'TRUK_ORIGIN_change_ITVI_ORIGIN_change': 4,  'VTRI_DESTINATION_change7_ITMS_DESTINATION_change7': 4, 'month_end':4,'TRUK_ORIGIN_slump':0}

model_specification_5={'HAUL_DESTINATION_7_min_change_percent': 5,  'ITMS_DESTINATION_14_stdev': 5,  'ITMS_DESTINATION_change7_ITRI_DESTINATION_change_sq': 5,  'ITMS_DESTINATION_change7_VTRI_ORIGIN_change7_sq': 5,  'ITVI_ORIGIN_7_mean_change_percent': 5,  'OTMS_DESTINATION_change7_TLT_DESTINATION_change': 5,  'OTMS_ORIGIN_14_stdev_change_sq': 5,  'OTRI_ORIGIN_change_OTMS_ORIGIN_change7': 5,  'OTVI_ORIGIN_7_mean_change_percent': 5,  'TRUK_ORIGIN_14_median_change_shift1': 5, 'month_end':5,'TRUK_ORIGIN_slump':0  }

model_specification_6={'HAUL_ORIGIN_7_stdev_change_percent_sq': 6,  'ITMS_DESTINATION_14_mean_sq': 6,  'ITMS_DESTINATION_change7_OTRI_ORIGIN_change7': 6,  'ITMS_ORIGIN_change_VTRI_ORIGIN_change': 6,  'ITRI_ORIGIN_change7_OTMS_DESTINATION_change7_sq': 6,  'OTMS_DESTINATION_14_median_sq': 6,  'OTVI_ORIGIN_change7_percent': 6,  'TLT_DESTINATION_14_stdev_sq': 6,  'TRUK_DESTINATION_7_mean_change_sq': 6,  'TRUK_DESTINATION_change7_ITVI_DESTINATION_change_sq': 6, 'month_end':6,'TRUK_ORIGIN_slump':0  }

model_specification_7={'HAUL_ORIGIN_14_stdev_change_percent': 7,  'ITMS_DESTINATION_sq': 7,  'ITVI_DESTINATION_change_VTRI_DESTINATION_change': 7,  'OTMS_DESTINATION_14_max_sq': 7,  'OTMS_ORIGIN_change7_ITRI_ORIGIN_change7': 7,  'OTRI_ORIGIN_change7_TRUK_DESTINATION_change7': 7,  'OTVI_ORIGIN_change_percent_sq': 7,  'TLT_DESTINATION_7_max': 7,  'TRUK_DESTINATION_14_stdev_change': 7, 'month_end':7,'TRUK_ORIGIN_slump':0 }

models_dict={'model_specification_1':model_specification_1,'model_specification_2':model_specification_2,            'model_specification_3':model_specification_3,'model_specification_4':model_specification_4,            'model_specification_5':model_specification_5,'model_specification_6':model_specification_6,            'model_specification_7':model_specification_7}
